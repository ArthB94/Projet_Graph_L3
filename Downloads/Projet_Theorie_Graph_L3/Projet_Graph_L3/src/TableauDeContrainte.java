...
public class TableauDeContrainte {
    ...
    public TableauDeContrainte(int[][] tab) {
        ...
        for (int j = 0; j < nomTaches.size(); j++) {
            // ajout dans la liste des taches
    ...
    public boolean DetectionCircuit(String affichage) {
        ...
        while (sommets.size() != sizePres) {
            ...
            for (int j = 0; j < sommets.size(); j++) {
                ...
                if (pointEntré && j != 0) {
                    // si on est sur un point d'entrée on supprime ce sommet de la liste des sommets
                    // à considérer
                    if (affichage != "off") {
                    ...
                    ///////////////////////////
                    // on supprime les colonnes et lignes correspondant au sommet supprimé
                    j--;
                }
    ...
    public void setMargeTotale(){
        for(Tache tache : taches){
            tache.marge = tache.dateTard - tache.dateTot;
        }
    }

    public String DisplayMarge(){
        String str = "Tableau de contraintes contenant les marges\n";
